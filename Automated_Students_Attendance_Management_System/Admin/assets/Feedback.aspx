<%@ Page Title="Feedback" Language="C#" MasterPageFile="~/Admin/assets/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Feedback.aspx.cs" Inherits="Automated_Students_Attendance_Management_System.Admin.assets.WebForm2" %>
 ...
 <asp:GridView Text-align="center" ID="GridView01" runat="server" 
    ...
    BorderStyle="Solid" BorderWidth="1px" Font-Size="Medium" OnSelectedIndexChanged="GridView01_SelectedIndexChanged" 
        ...
        <Columns>
            ...
            <ItemTemplate>
                <asp:Label ID="lblcourse" runat="server" Text='<%#Eval("email") %>'></asp:Label>
            </ItemTemplate>
